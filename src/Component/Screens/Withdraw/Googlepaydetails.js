...
const Googlepaydetails = ({ navigation, route }) => {
  ...
  const onSubmit = () => {
    ...
    if (bankDetails.googlepaynumber == "") {
      setpaytm_numerError("Goggle Pay Number is required");
    } else {
      const PayloadData = {
        notes: `${"GooglePay"},${bankDetails?.Name},${
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.aqua }}>
      ...
      >
        ...
        >
          ...
          <View style={styles.viewStyle}>
            <Text style={styles.textStyle}>{String.GooglePay}</Text>
            ...
            <TextInput
              ...
              onChangeText={(text) => {
                setBankDetail(
                  { ...bankDetails, googlepaynumber: text },
                  setpaytm_numerError("")
                );
              }}
            />
